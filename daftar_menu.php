...
<html lang="en">
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg">
        <div class="container">
        <a class="navbar-brand" href="daftar_menu.php"><strong>Mangan Disik</strong> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link pinned rounded-pill px-3 mr-4" href="pesanan_pembeli.php">DATA ADMIN</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->
      <div class="container">
        <a href="tambah_menu.php" class="btn btn-success btn-dark mt-3"button style="background-color:rgb(36, 113, 165);">TAMBAH DAFTAR MENU</a>
        <a href="rekamKerja.php" class="btn btn-success mt-3"button style="background-color:green;">REKAM KERJA</a>
        <div class="row">
          ...
          $query = sqlsrv_query($koneksi, 'SELECT * FROM Menu');
          ...
          <div class="col-md-3 mt-4">
            <div class="card brder-dark">
              ...
              <div class="card-body">
                <h5 class="card-title font-weight-bold"><?php echo $result['NamaMenu'] ?></h5>
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result['HargaMenu']); ?></label><br>
                <a href="edit_menu.php?id_menu=<?php echo $result['IdMenu']  ?>" class="btn btn-success btn-sm btn-block"button style="background-color:rgb(36, 113, 165);">EDIT</a>

                <a href="hapus_menu.php?id_menu=<?php echo $result['IdMenu']  ?>" class="btn btn-dark btn-danger btn-sm btn-block text-light">HAPUS</a>
              </div>
            </div>
          </div>
              <?php endwhile; ?>
        ...
        <div class="container">
            <div class="row py-4 justify-content-lg-between">
                ...
                <div class="col-lg-3 col-12 my-auto align-left mb-1">
                    <a class="navbar-brand text" href="chef.php">
