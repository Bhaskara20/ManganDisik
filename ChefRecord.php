    ...
    /*session_start();
      if(!isset($_SESSION['login_user'])) {
        ...
        $sql = "SELECT * FROM DetailPesanan
                ...
                JOIN JuruMasak ON DetailPesanan.IdJuruMasak = JuruMasak.IdJuruMasak WHERE IdJenisMenu='2'";
  ...
  <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link pinned rounded-pill px-3 mr-4" href="pesanan_pembeli.php">REKAM KERJA CHEF</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold">Rekam Kerja Chef</h3>
        ...
        <div class="container">
            <div class="row py-4 justify-content-lg-between">
                ...
                <div class="col-lg-3 col-12 my-auto align-left mb-1">
                    <a class="navbar-brand text" href="rekamKerja.php">
