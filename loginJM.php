      ...
      <?php 
        if(isset($_POST['submit'])) {
          $username = $_POST['username'];
            $pass = $_POST['password'];
            $login =  "SELECT * FROM JuruMasak WHERE UsernameJuruMasak = '$username' AND PasswordJuruMasak = '$pass'";
            ...
            if ($ketemu)  {
                ...
                $_SESSION['IdJuruMasak']                       = $r['IdJuruMasak'];

                $_SESSION['NamaJuruMasak']                  = $r['NamaJuruMasak'];

                $_SESSION['UsernameJuruMasak']        = $r['UsernameJuruMasak'];

                $_SESSION['PasswordJuruMasak']                   = $r['PasswordJuruMasak'];
