    ...
    /*session_start();
      if(!isset($_SESSION['login_user'])) {
        ...
        $sql = "SELECT * FROM DetailPesanan
                ...
                JOIN Barista ON DetailPesanan.IdBarista = Barista.IdBarista WHERE IdJenisMenu='3'";
  ...
  <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link pinned rounded-pill px-3 mr-4" href="pesanan_pembeli.php">REKAM KERJA BARISTA</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold">Rekam Kerja Barista</h3>
