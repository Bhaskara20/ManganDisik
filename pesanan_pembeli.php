    ...
    /*session_start();
      if(!isset($_SESSION['login_user'])) {
        ...
        if(!isset($_SESSION['IdPelanggan'])) {
          header("location: loginPE.php");
        }else {
        }
        if(!isset($_SESSION['id_transaksi'])){
          echo "<script>alert('Anda belum memesan apapun !');</script>";
          echo "<script>location= 'menu_pembeli.php'</script>";
        }
        $id_transaksi = $_SESSION['id_transaksi'];
        $sql = "SELECT * FROM DetailPesanan
                JOIN Menu ON DetailPesanan.IdMenu = Menu.IdMenu WHERE IdTransaksi = $id_transaksi";
  ...
  <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link pinned rounded-pill px-3 mr-4" href="pesanan_pembeli.php">PESANAN ANDA</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>Rp. <?= number_format($result["HargaMenu"]); ?></td>
            <td><?php echo $result["JumlahMenu"];  ?></td>
            <td>Rp. <?php echo  number_format($subharga) ?></td>
            <td>
              <a href="hapus_pesanan.php?id_detail=<?= $result["IdDetailTransaksi"]; ?>" class="badge badge-danger">Hapus</a>
            </td>
          </tr>
      ...
      <form method="POST" action="">
        ...
        <button class="btn btn-success btn-sm" name="konfirm"button style="background-color:rgb(36, 113, 165);">Konfirmasi Pesanan</button>
      </form>        

      <?php 
      if(isset($_POST['konfirm'])) {
          //$tanggal = date("Y-m-d");
          $masuk_transaksi = "UPDATE Transaksi SET TotalPembayaran = '$totalbelanja' WHERE IdTransaksi = $id_transaksi";
        ...
        <div class="container">
            <div class="row py-4 justify-content-lg-between">
                ...
                <div class="col-lg-3 col-12 my-auto align-left mb-1">
                    <a class="navbar-brand text" href="user.php">
