    ...
    /*session_start();
      if(!isset($_SESSION['login_user'])) {
        ...
        $sql = "SELECT * FROM DetailPesanan
                ...
                JOIN Kasir ON Transaksi.IdKasir = Kasir.IdKasir";
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg">
        <div class="container">
        <a class="navbar-brand" href="rekamKerja.php"><strong>Mangan Disik</strong> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link pinned rounded-pill px-3 mr-4" href="pesanan_pembeli.php">REKAM KERJA KASIR</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold">Daftar Transaksi</h3>
      ...
      <table class="table table-bordered" id="example">
        <thead class="thead-light">
          <tr>
            ...
            <th scope="col">Nama Petugas Kasir</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?=$result["NamaKasir"]; ?></td>
            <td><?php echo $result["JumlahMenu"];  ?></td>td>
