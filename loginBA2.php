   ...
   <?php 
        if(isset($_POST['submit'])) {
          $username = $_POST['username'];
            $pass = $_POST['password'];
            $login =  "SELECT * FROM Barista WHERE UsernameBarista = '$username' AND PasswordBarista = '$pass'";
            ...
            if ($ketemu)  {
                ...
                $_SESSION['IdBarista']                       = $r['IdBarista'];

                $_SESSION['NamaBarista']                  = $r['NamaBarista'];

                $_SESSION['UsernameBarista']        = $r['UsernameBarista'];

                $_SESSION['PasswordBarista']                   = $r['PasswordBarista'];
