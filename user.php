  ...
  <nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link pinned rounded-pill px-3  mr-4" href="user.php">HOME</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->    
      <div class="container" style="margin-bottom : 50px">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">Mangan Disik</h3>
          <h5>Resto keluarga Pas Dikantong
        ...
        <div class="row mb-5 mt-5 ">
          <div class="col-md-6 d-flex justify-content-end" >
            <div class="card bg-dark text-white border-light">
              ...
              <div class="card-img-overlay mt-5 text-center">
               <a href="menu_pembeli.php" class="btn btn-primary  center-blok"button style="background-color:rgb(36, 113, 165);">LIHAT DAFTAR MENU</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card bg-dark text-white border-light">
              ...
              <div class="card-img-overlay mt-5 text-center">
               <a href="pesanan_pembeli.php" class="btn btn-primary  visiblecenter-blok"button style="background-color:rgb(36, 113, 165);">LIHAT PESANAN</a>
              </div>
            </div>
          </div>
        </div>
