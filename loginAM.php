      ...
      <?php 
        if(isset($_POST['submit'])) {
          $username = $_POST['username'];
            $pass = $_POST['password'];
            $login =  "SELECT * FROM Administrator WHERE UsernameAdmin = '$username' AND PasswordAdmin = '$pass'";
            ...
            if ($ketemu)  {
                ...
                $_SESSION['NamaAdmin']                  = $r['NamaAdmin'];

                $_SESSION['UsernameAdmin']        = $r['UsernameAdmin'];

                $_SESSION['PasswordAdmin']                   = $r['PasswordAdmin'];
