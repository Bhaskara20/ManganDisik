...
<html lang="en">
 ...
 <!-- Form Registrasi -->
        ...
        <div class="form-group">
          ...
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="2" name="jenis_menu" checked>Makanan 
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
  ...
  if(isset($_POST['tambah'])){
    ...
    $insert = sqlsrv_query($koneksi, "INSERT INTO Menu (IdJenisMenu,NamaMenu,HargaMenu) VALUES ('$jenis','$nama','$harga')");
