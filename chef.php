...
include('koneksi.php');
    /*session_start();
      if(!isset($_SESSION['login_user'])) {
        ...
        $id_juru_masak = $_SESSION['IdJuruMasak'];
        if(!isset($id_juru_masak)) {
          header("location: loginJM.php");
        }else {
        }
        $sql = "SELECT * FROM DetailPesanan
                JOIN Menu ON DetailPesanan.IdMenu = Menu.IdMenu WHERE IdJuruMasak IS NULL AND IdJenisMenu='2'";
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg">
        <div class="container">
        <a class="navbar-brand" href="chef.php"><strong>Mangan Disik</strong> </a>
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="terimaTugas.php?id_detail=<?= $result["IdDetailTransaksi"]; ?>&id_juru_masak=<?= $id_juru_masak; ?>" class="badge badge-success">Terima</a>
            </td>
          </tr>
            <?php 
            ?>
