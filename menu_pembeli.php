            ...
            <div class="card brder-dark">
              ...
              <div class="card-body">
               ...
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result["HargaMenu"]); ?></label><br>
                <a href="beli.php?id_menu=<?php echo $result["IdMenu"]; ?>&nama_menu=<?= $result['NamaMenu'] ?>" class="btn btn-success btn-sm btn-block "button style="background-color:rgb(36, 113, 165);">BELI</a>
              </div>
            </div>
          </div>
          <?php endwhile; ?>
