    ...
    /*session_start();
      if(!isset($_SESSION['login_user'])) {
        ...
        $sql = "SELECT * FROM DetailPesanan
                ...
                JOIN Transaksi ON DetailPesanan.IdTransaksi = Transaksi.IdTransaksi
                JOIN Pelanggan ON Transaksi.idPelanggan = Pelanggan.IdPelanggan WHERE IdKasir IS NULL";
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg">
        <div class="container">
        <a class="navbar-brand" href="kasir.php"><strong>Mangan Disik</strong> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link pinned rounded-pill px-3 mr-4" href="pesanan_pembeli.php">SILAHKAN KONFIRMASI PESANAN</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold">Konfirmasi Pesanan</h3>
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <tr>
            <td><?= $nomor++; ?></td>
            <td><?=$result["NamaPelanggan"]; ?></td>
            <td><?=$result["NamaMenu"]; ?></td>
            <td><?php echo $result["JumlahMenu"];  ?></td>
            <td>Rp. <?php echo  number_format($subharga) ?></td>
            <td>
              <a href="terimaTugasKasir.php?id_detail=<?= $result["IdTransaksi"]; ?>&id_Kasir=<?= $id_Kasir; ?>" class="badge badge-success">Konfirmasi</a>
            </td>
          </tr>
            <?php 
            ?>
        ...
        <div class="container">
            <div class="row py-4 justify-content-lg-between">
                ...
                <div class="col-lg-3 col-12 my-auto align-left mb-1">
                    <a class="navbar-brand text" href="kasir.php">
